...
export const tr = {
  ...
  ceiling: {
    ...
    title: { pre: "Kapıyı da,", em: "tavanı da", post: "aynı ekipten alın." },
    subtitle:
      "Asma tavanı, aydınlatmayı ve alçı tavan detaylarını projenin ölçüsüne göre hazırlıyoruz. Malzeme, termin ve uygulama tek elden ilerliyor.",
    items: {
      suspended: { title: "Asma Tavan", desc: "T-profil, mineral ve metal paneller; projeye göre ölçülü üretim" },
      lighting: { title: "Tavan Aydınlatma", desc: "Spot, lineer LED ve armatür seçenekleri" },
      gypsum: { title: "Alçı Tavan", desc: "Kartonpiyer, kademeli tavan ve dekoratif bordürler" },
    },
  },
  engineering: {

...
export const en: Dictionary = {
  ...
  ceiling: {
    ...
    title: { pre: "Doors and ceilings,", em: "one", post: "team." },
    subtitle:
      "We prepare suspended ceilings, lighting and gypsum ceiling details around the project's dimensions. Materials, lead times and installation stay coordinated.",
    items: {
      suspended: { title: "Suspended Ceiling", desc: "T-profiles, mineral and metal panels made to project dimensions" },
      lighting: { title: "Ceiling Lighting", desc: "Spotlights, linear LEDs and luminaire options" },
      gypsum: { title: "Gypsum Ceiling", desc: "Cornices, stepped ceilings and decorative borders" },
    },
  },
  engineering: {
